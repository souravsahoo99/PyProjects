# ============================================================
# DISPLAY MONITOR v1.1
# Checkpoint 3.0 Engine Monitor
# Production Grade (Supervisor Safe)
# ============================================================
...
# ============================================================
# SINGLETON MONITOR
# Prevents duplicate windows during engine restart
# ============================================================
...
class DisplayMonitor:
    ...
    def __init__(self, engine, trade_managers, nodes):
        ...
        self.root.title("Trading Engine Monitor — Checkpoint 3.0")
    ...
    def _update_lights(self):
        ...
        try:
            status = self.engine.ws_connected
        except Exception:
            status = False
    ...
    def _update_managers(self):
        ...
        for tm, widget in self.manager_windows:
            ...
            try:
                ...
                data = json.dumps(tm.trade, indent=4)
